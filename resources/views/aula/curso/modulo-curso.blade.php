    ...
    <div class="row mb-2">
      <div class="col-sm-12">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Modulo 1</li>
...
<div class="card">
  ...
  <div class="card-body">
    <h1>Modulo 1: <b>Nombre del Modulo</b></h1>
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h2>Modulo 1: Titulo del Modulo</h2>
          </div>
          <div class="card-body">
        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Espacio de Interacción</h3>
